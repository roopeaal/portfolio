...
export const projects: Project[] = [
  ...
  },
  {
    ...
    technicalScope: "Interactive device layout, animated topology, draggable elements, modal windows, custom SVG device art and GitHub Pages deployment.",
    environment: "React / Next.js project deployed as a static site.",
    implementation: "Built a topology-style UI, custom device windows, project overview flows, LinkedIn browser preview and deployment pipeline fixes for GitHub Pages.",
    validation: "Local builds, static export checks, path fixes for GitHub Pages and iterative UI refinement directly against visual references.",
    result: "A distinctive portfolio homepage that works as both a personal site and a technical design showcase.",
    learned: "Sharper frontend polishing skills, safer refactoring under pressure and better judgement for turning a concept into a deployable product.",
  ...
  },
  {
    ...
    validation: "Manual playtesting, replay checks and comparison of the original logic against the browser version.",
  ...
  },
  {
    ...
    implementation: "Built a small monitoring-style interface with at least button/input driven interaction and a visual result area for BPM data.",
    validation: "UI interaction tests, state update checks and verification that displayed values react correctly to input.",
    result: "A compact but relevant frontend project showing that the UI was not static and included actual logic.",
    learned: "More confidence in building interfaces where data, user actions and visible output all connect cleanly.",
  ...
  },
  {
    ...
    implementation: "Designed a Metropolia-style login concept around real-world sign-in conventions and a student-service context.",
