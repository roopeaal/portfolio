...
export function TopologyHero() {
  ...
  const switchCableOverlayClip = {
    x: topologyNodePositions.projects.x - 70,
    y: topologyNodePositions.projects.y - 26,
    width: NODE_META.projects.width + 140,
    height: 230,
  };
  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={hoverActive ? { y: [0, -1, 0] } : { y: 0 }}
        transition={hoverActive ? { duration: 0.55, repeat: 1, ease: "easeInOut" } : { duration: 0.2 }}
      >
        <svg
